...
INGREDIENTES = ["","naranja","verdeo","crema","azucar impalpable","batata","manzana","bondiola","durazno","berenjena","pechuga","oliva","harina", "leche", "azucar", "queso", "tomate", "huevo", "crema", "nuez", "arroz", "chocolate", "carne", "pollo","jengibre", "miel", "levadura", "papa", "almendra", "jamon", "calabaza", "aceitunas", "arveja", "garbanzos", "espinaca", "acelga", "quinoa", "frutilla", "avellana", "apio", "puerro", "limon", "chorizo", "avena", "salmon", "mani", "brocoli", "cerveza", "mozzarella", "ricota", "esparragos", "quinoa", "azafran", "panceta", "tofu", "pastas"] 

#mismos ingredientes, pero con mayúsculas y tildes para la lista desplegable
ingred_choice = ("",'Aceitunas', 'Acelga', 'Almendra', 'Apio', 'Arroz', 'Arveja', 'Avellana', 'Avena', 'Azafrán', 'Azúcar', 'Azúcar impalpable', 'Batata', 'Berenjena', 'Bondiola', 'Brócoli', 'Calabaza', 'Carne', 'Cerveza', 'Chocolate', 'Chorizo', 'Crema', 'Durazno', 'Espinaca', 'Espárragos', 'Pasta', 'Frutilla', 'Garbanzos', 'Harina', 'Huevo', 'Jamón', 'Jengibre', 'Leche', 'Levadura', 'Limón', 'Manzana', 'Maní', 'Miel', 'Mozzarella', 'Naranja', 'Nuez', 'Oliva', 'Panceta', 'Papa', "Pastas", 'Pechuga', 'Pollo', 'Puerro', 'Queso', 'Quinoa', 'Ricota', 'Salmón', 'Tofu', 'Tomate', 'Verdeo')
